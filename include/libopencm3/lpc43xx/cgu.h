...
#define CGU_PLL0AUDIO_FRAC              MMIO32(CGU_BASE + 0x03C)
...
#define CGU_BASE_AUDIO_CLK              MMIO32(CGU_BASE + 0x0C0)
...
#define CGU_FREQ_MON_MEAS_MASK (0x1 << CGU_FREQ_MON_MEAS_SHIFT)
#define CGU_FREQ_MON_MEAS(x) ((x) << CGU_FREQ_MON_MEAS_SHIFT)
...
#define CGU_XTAL_OSC_CTRL_ENABLE_MASK (0x1 << CGU_XTAL_OSC_CTRL_ENABLE_SHIFT)
#define CGU_XTAL_OSC_CTRL_ENABLE(x) ((x) << CGU_XTAL_OSC_CTRL_ENABLE_SHIFT)

/* BYPASS: Configure crystal operation or external-clock input pin XTAL1 */
#define CGU_XTAL_OSC_CTRL_BYPASS_SHIFT (1)
#define CGU_XTAL_OSC_CTRL_BYPASS_MASK (0x1 << CGU_XTAL_OSC_CTRL_BYPASS_SHIFT)
#define CGU_XTAL_OSC_CTRL_BYPASS(x) ((x) << CGU_XTAL_OSC_CTRL_BYPASS_SHIFT)

/* HF: Select frequency range */
#define CGU_XTAL_OSC_CTRL_HF_SHIFT (2)
#define CGU_XTAL_OSC_CTRL_HF_MASK (0x1 << CGU_XTAL_OSC_CTRL_HF_SHIFT)
#define CGU_XTAL_OSC_CTRL_HF(x) ((x) << CGU_XTAL_OSC_CTRL_HF_SHIFT)

/* --- CGU_PLL0USB_STAT values ---------------------------------- */

/* LOCK: PLL0 lock indicator */
#define CGU_PLL0USB_STAT_LOCK_SHIFT (0)
#define CGU_PLL0USB_STAT_LOCK_MASK (0x1 << CGU_PLL0USB_STAT_LOCK_SHIFT)
#define CGU_PLL0USB_STAT_LOCK(x) ((x) << CGU_PLL0USB_STAT_LOCK_SHIFT)

/* FR: PLL0 free running indicator */
#define CGU_PLL0USB_STAT_FR_SHIFT (1)
#define CGU_PLL0USB_STAT_FR_MASK (0x1 << CGU_PLL0USB_STAT_FR_SHIFT)
#define CGU_PLL0USB_STAT_FR(x) ((x) << CGU_PLL0USB_STAT_FR_SHIFT)

/* --- CGU_PLL0USB_CTRL values ---------------------------------- */

/* PD: PLL0 power down */
#define CGU_PLL0USB_CTRL_PD_SHIFT (0)
#define CGU_PLL0USB_CTRL_PD_MASK (0x1 << CGU_PLL0USB_CTRL_PD_SHIFT)
#define CGU_PLL0USB_CTRL_PD(x) ((x) << CGU_PLL0USB_CTRL_PD_SHIFT)

/* BYPASS: Input clock bypass control */
#define CGU_PLL0USB_CTRL_BYPASS_SHIFT (1)
#define CGU_PLL0USB_CTRL_BYPASS_MASK (0x1 << CGU_PLL0USB_CTRL_BYPASS_SHIFT)
#define CGU_PLL0USB_CTRL_BYPASS(x) ((x) << CGU_PLL0USB_CTRL_BYPASS_SHIFT)

/* DIRECTI: PLL0 direct input */
#define CGU_PLL0USB_CTRL_DIRECTI_SHIFT (2)
#define CGU_PLL0USB_CTRL_DIRECTI_MASK (0x1 << CGU_PLL0USB_CTRL_DIRECTI_SHIFT)
#define CGU_PLL0USB_CTRL_DIRECTI(x) ((x) << CGU_PLL0USB_CTRL_DIRECTI_SHIFT)

/* DIRECTO: PLL0 direct output */
#define CGU_PLL0USB_CTRL_DIRECTO_SHIFT (3)
#define CGU_PLL0USB_CTRL_DIRECTO_MASK (0x1 << CGU_PLL0USB_CTRL_DIRECTO_SHIFT)
#define CGU_PLL0USB_CTRL_DIRECTO(x) ((x) << CGU_PLL0USB_CTRL_DIRECTO_SHIFT)

/* CLKEN: PLL0 clock enable */
#define CGU_PLL0USB_CTRL_CLKEN_SHIFT (4)
#define CGU_PLL0USB_CTRL_CLKEN_MASK (0x1 << CGU_PLL0USB_CTRL_CLKEN_SHIFT)
#define CGU_PLL0USB_CTRL_CLKEN(x) ((x) << CGU_PLL0USB_CTRL_CLKEN_SHIFT)

/* FRM: Free running mode */
#define CGU_PLL0USB_CTRL_FRM_SHIFT (6)
#define CGU_PLL0USB_CTRL_FRM_MASK (0x1 << CGU_PLL0USB_CTRL_FRM_SHIFT)
#define CGU_PLL0USB_CTRL_FRM(x) ((x) << CGU_PLL0USB_CTRL_FRM_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_PLL0USB_CTRL_AUTOBLOCK_SHIFT (11)
#define CGU_PLL0USB_CTRL_AUTOBLOCK_MASK (0x1 << CGU_PLL0USB_CTRL_AUTOBLOCK_SHIFT)
#define CGU_PLL0USB_CTRL_AUTOBLOCK(x) ((x) << CGU_PLL0USB_CTRL_AUTOBLOCK_SHIFT)
...
#define CGU_PLL0AUDIO_STAT_LOCK_MASK (0x1 << CGU_PLL0AUDIO_STAT_LOCK_SHIFT)
#define CGU_PLL0AUDIO_STAT_LOCK(x) ((x) << CGU_PLL0AUDIO_STAT_LOCK_SHIFT)

/* FR: PLL0 free running indicator */
#define CGU_PLL0AUDIO_STAT_FR_SHIFT (1)
#define CGU_PLL0AUDIO_STAT_FR_MASK (0x1 << CGU_PLL0AUDIO_STAT_FR_SHIFT)
#define CGU_PLL0AUDIO_STAT_FR(x) ((x) << CGU_PLL0AUDIO_STAT_FR_SHIFT)

/* --- CGU_PLL0AUDIO_CTRL values -------------------------------- */

/* PD: PLL0 power down */
#define CGU_PLL0AUDIO_CTRL_PD_SHIFT (0)
#define CGU_PLL0AUDIO_CTRL_PD_MASK (0x1 << CGU_PLL0AUDIO_CTRL_PD_SHIFT)
#define CGU_PLL0AUDIO_CTRL_PD(x) ((x) << CGU_PLL0AUDIO_CTRL_PD_SHIFT)

/* BYPASS: Input clock bypass control */
#define CGU_PLL0AUDIO_CTRL_BYPASS_SHIFT (1)
#define CGU_PLL0AUDIO_CTRL_BYPASS_MASK (0x1 << CGU_PLL0AUDIO_CTRL_BYPASS_SHIFT)
#define CGU_PLL0AUDIO_CTRL_BYPASS(x) ((x) << CGU_PLL0AUDIO_CTRL_BYPASS_SHIFT)

/* DIRECTI: PLL0 direct input */
#define CGU_PLL0AUDIO_CTRL_DIRECTI_SHIFT (2)
#define CGU_PLL0AUDIO_CTRL_DIRECTI_MASK (0x1 << CGU_PLL0AUDIO_CTRL_DIRECTI_SHIFT)
#define CGU_PLL0AUDIO_CTRL_DIRECTI(x) ((x) << CGU_PLL0AUDIO_CTRL_DIRECTI_SHIFT)

/* DIRECTO: PLL0 direct output */
#define CGU_PLL0AUDIO_CTRL_DIRECTO_SHIFT (3)
#define CGU_PLL0AUDIO_CTRL_DIRECTO_MASK (0x1 << CGU_PLL0AUDIO_CTRL_DIRECTO_SHIFT)
#define CGU_PLL0AUDIO_CTRL_DIRECTO(x) ((x) << CGU_PLL0AUDIO_CTRL_DIRECTO_SHIFT)

/* CLKEN: PLL0 clock enable */
#define CGU_PLL0AUDIO_CTRL_CLKEN_SHIFT (4)
#define CGU_PLL0AUDIO_CTRL_CLKEN_MASK (0x1 << CGU_PLL0AUDIO_CTRL_CLKEN_SHIFT)
#define CGU_PLL0AUDIO_CTRL_CLKEN(x) ((x) << CGU_PLL0AUDIO_CTRL_CLKEN_SHIFT)

/* FRM: Free running mode */
#define CGU_PLL0AUDIO_CTRL_FRM_SHIFT (6)
#define CGU_PLL0AUDIO_CTRL_FRM_MASK (0x1 << CGU_PLL0AUDIO_CTRL_FRM_SHIFT)
#define CGU_PLL0AUDIO_CTRL_FRM(x) ((x) << CGU_PLL0AUDIO_CTRL_FRM_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_PLL0AUDIO_CTRL_AUTOBLOCK_SHIFT (11)
#define CGU_PLL0AUDIO_CTRL_AUTOBLOCK_MASK (0x1 << CGU_PLL0AUDIO_CTRL_AUTOBLOCK_SHIFT)
#define CGU_PLL0AUDIO_CTRL_AUTOBLOCK(x) ((x) << CGU_PLL0AUDIO_CTRL_AUTOBLOCK_SHIFT)

/* PLLFRACT_REQ: Fractional PLL word write request */
#define CGU_PLL0AUDIO_CTRL_PLLFRACT_REQ_SHIFT (12)
#define CGU_PLL0AUDIO_CTRL_PLLFRACT_REQ_MASK (0x1 << CGU_PLL0AUDIO_CTRL_PLLFRACT_REQ_SHIFT)
#define CGU_PLL0AUDIO_CTRL_PLLFRACT_REQ(x) ((x) << CGU_PLL0AUDIO_CTRL_PLLFRACT_REQ_SHIFT)

/* SEL_EXT: Select fractional divider */
#define CGU_PLL0AUDIO_CTRL_SEL_EXT_SHIFT (13)
#define CGU_PLL0AUDIO_CTRL_SEL_EXT_MASK (0x1 << CGU_PLL0AUDIO_CTRL_SEL_EXT_SHIFT)
#define CGU_PLL0AUDIO_CTRL_SEL_EXT(x) ((x) << CGU_PLL0AUDIO_CTRL_SEL_EXT_SHIFT)

/* MOD_PD: Sigma-Delta modulator power-down */
#define CGU_PLL0AUDIO_CTRL_MOD_PD_SHIFT (14)
#define CGU_PLL0AUDIO_CTRL_MOD_PD_MASK (0x1 << CGU_PLL0AUDIO_CTRL_MOD_PD_SHIFT)
#define CGU_PLL0AUDIO_CTRL_MOD_PD(x) ((x) << CGU_PLL0AUDIO_CTRL_MOD_PD_SHIFT)
...
/* --- CGU_PLL0AUDIO_FRAC values -------------------------------- */

/* PLLFRACT_CTRL: PLL fractional divider control word */
#define CGU_PLL0AUDIO_FRAC_PLLFRACT_CTRL_SHIFT (0)
#define CGU_PLL0AUDIO_FRAC_PLLFRACT_CTRL_MASK (0x3fffff << CGU_PLL0AUDIO_FRAC_PLLFRACT_CTRL_SHIFT)
#define CGU_PLL0AUDIO_FRAC_PLLFRACT_CTRL(x) ((x) << CGU_PLL0AUDIO_FRAC_PLLFRACT_CTRL_SHIFT)

/* --- CGU_PLL1_STAT values ------------------------------------- */

/* LOCK: PLL1 lock indicator */
#define CGU_PLL1_STAT_LOCK_SHIFT (0)
#define CGU_PLL1_STAT_LOCK_MASK (0x1 << CGU_PLL1_STAT_LOCK_SHIFT)
#define CGU_PLL1_STAT_LOCK(x) ((x) << CGU_PLL1_STAT_LOCK_SHIFT)

/* --- CGU_PLL1_CTRL values ------------------------------------- */

/* PD: PLL1 power down */
#define CGU_PLL1_CTRL_PD_SHIFT (0)
#define CGU_PLL1_CTRL_PD_MASK (0x1 << CGU_PLL1_CTRL_PD_SHIFT)
#define CGU_PLL1_CTRL_PD(x) ((x) << CGU_PLL1_CTRL_PD_SHIFT)

/* BYPASS: Input clock bypass control */
#define CGU_PLL1_CTRL_BYPASS_SHIFT (1)
#define CGU_PLL1_CTRL_BYPASS_MASK (0x1 << CGU_PLL1_CTRL_BYPASS_SHIFT)
#define CGU_PLL1_CTRL_BYPASS(x) ((x) << CGU_PLL1_CTRL_BYPASS_SHIFT)

/* FBSEL: PLL feedback select */
#define CGU_PLL1_CTRL_FBSEL_SHIFT (6)
#define CGU_PLL1_CTRL_FBSEL_MASK (0x1 << CGU_PLL1_CTRL_FBSEL_SHIFT)
#define CGU_PLL1_CTRL_FBSEL(x) ((x) << CGU_PLL1_CTRL_FBSEL_SHIFT)

/* DIRECT: PLL direct CCO output */
#define CGU_PLL1_CTRL_DIRECT_SHIFT (7)
#define CGU_PLL1_CTRL_DIRECT_MASK (0x1 << CGU_PLL1_CTRL_DIRECT_SHIFT)
#define CGU_PLL1_CTRL_DIRECT(x) ((x) << CGU_PLL1_CTRL_DIRECT_SHIFT)
...
#define CGU_PLL1_CTRL_AUTOBLOCK_MASK (0x1 << CGU_PLL1_CTRL_AUTOBLOCK_SHIFT)
#define CGU_PLL1_CTRL_AUTOBLOCK(x) ((x) << CGU_PLL1_CTRL_AUTOBLOCK_SHIFT)
...
#define CGU_IDIVA_CTRL_PD_MASK (0x1 << CGU_IDIVA_CTRL_PD_SHIFT)
#define CGU_IDIVA_CTRL_PD(x) ((x) << CGU_IDIVA_CTRL_PD_SHIFT)
...
#define CGU_IDIVA_CTRL_AUTOBLOCK_MASK (0x1 << CGU_IDIVA_CTRL_AUTOBLOCK_SHIFT)
#define CGU_IDIVA_CTRL_AUTOBLOCK(x) ((x) << CGU_IDIVA_CTRL_AUTOBLOCK_SHIFT)
...
#define CGU_IDIVB_CTRL_PD_MASK (0x1 << CGU_IDIVB_CTRL_PD_SHIFT)
#define CGU_IDIVB_CTRL_PD(x) ((x) << CGU_IDIVB_CTRL_PD_SHIFT)
...
#define CGU_IDIVB_CTRL_AUTOBLOCK_MASK (0x1 << CGU_IDIVB_CTRL_AUTOBLOCK_SHIFT)
#define CGU_IDIVB_CTRL_AUTOBLOCK(x) ((x) << CGU_IDIVB_CTRL_AUTOBLOCK_SHIFT)
...
#define CGU_IDIVC_CTRL_PD_MASK (0x1 << CGU_IDIVC_CTRL_PD_SHIFT)
#define CGU_IDIVC_CTRL_PD(x) ((x) << CGU_IDIVC_CTRL_PD_SHIFT)
...
#define CGU_IDIVC_CTRL_AUTOBLOCK_MASK (0x1 << CGU_IDIVC_CTRL_AUTOBLOCK_SHIFT)
#define CGU_IDIVC_CTRL_AUTOBLOCK(x) ((x) << CGU_IDIVC_CTRL_AUTOBLOCK_SHIFT)
...
#define CGU_IDIVD_CTRL_PD_MASK (0x1 << CGU_IDIVD_CTRL_PD_SHIFT)
...
#define CGU_IDIVD_CTRL_AUTOBLOCK_MASK (0x1 << CGU_IDIVD_CTRL_AUTOBLOCK_SHIFT)
#define CGU_IDIVD_CTRL_AUTOBLOCK(x) ((x) << CGU_IDIVD_CTRL_AUTOBLOCK_SHIFT)
...
#define CGU_IDIVE_CTRL_PD_MASK (0x1 << CGU_IDIVE_CTRL_PD_SHIFT)
#define CGU_IDIVE_CTRL_PD(x) ((x) << CGU_IDIVE_CTRL_PD_SHIFT)
...
#define CGU_IDIVE_CTRL_AUTOBLOCK_MASK (0x1 << CGU_IDIVE_CTRL_AUTOBLOCK_SHIFT)
#define CGU_IDIVE_CTRL_AUTOBLOCK(x) ((x) << CGU_IDIVE_CTRL_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_SAFE_CLK_PD_MASK (0x1 << CGU_BASE_SAFE_CLK_PD_SHIFT)
#define CGU_BASE_SAFE_CLK_PD(x) ((x) << CGU_BASE_SAFE_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_SAFE_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_SAFE_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_SAFE_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_SAFE_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_SAFE_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_USB0_CLK_PD_MASK (0x1 << CGU_BASE_USB0_CLK_PD_SHIFT)
#define CGU_BASE_USB0_CLK_PD(x) ((x) << CGU_BASE_USB0_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_USB0_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_USB0_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_USB0_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_USB0_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_USB0_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_PERIPH_CLK_PD_MASK (0x1 << CGU_BASE_PERIPH_CLK_PD_SHIFT)
#define CGU_BASE_PERIPH_CLK_PD(x) ((x) << CGU_BASE_PERIPH_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_PERIPH_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_PERIPH_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_PERIPH_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_PERIPH_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_PERIPH_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_USB1_CLK_PD_MASK (0x1 << CGU_BASE_USB1_CLK_PD_SHIFT)
#define CGU_BASE_USB1_CLK_PD(x) ((x) << CGU_BASE_USB1_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_USB1_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_USB1_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_USB1_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_USB1_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_USB1_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_M4_CLK_PD_MASK (0x1 << CGU_BASE_M4_CLK_PD_SHIFT)
#define CGU_BASE_M4_CLK_PD(x) ((x) << CGU_BASE_M4_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_M4_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_M4_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_M4_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_M4_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_M4_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_SPIFI_CLK_PD_MASK (0x1 << CGU_BASE_SPIFI_CLK_PD_SHIFT)
#define CGU_BASE_SPIFI_CLK_PD(x) ((x) << CGU_BASE_SPIFI_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_SPIFI_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_SPIFI_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_SPIFI_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_SPI_CLK_PD_MASK (0x1 << CGU_BASE_SPI_CLK_PD_SHIFT)
#define CGU_BASE_SPI_CLK_PD(x) ((x) << CGU_BASE_SPI_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_SPI_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_SPI_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_SPI_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_PHY_RX_CLK_PD_MASK (0x1 << CGU_BASE_PHY_RX_CLK_PD_SHIFT)
#define CGU_BASE_PHY_RX_CLK_PD(x) ((x) << CGU_BASE_PHY_RX_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_PHY_RX_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_PHY_RX_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_PHY_RX_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_PHY_RX_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_PHY_RX_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_PHY_TX_CLK_PD_MASK (0x1 << CGU_BASE_PHY_TX_CLK_PD_SHIFT)
#define CGU_BASE_PHY_TX_CLK_PD(x) ((x) << CGU_BASE_PHY_TX_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_PHY_TX_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_PHY_TX_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_PHY_TX_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_PHY_TX_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_PHY_TX_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_APB1_CLK_PD_MASK (0x1 << CGU_BASE_APB1_CLK_PD_SHIFT)
#define CGU_BASE_APB1_CLK_PD(x) ((x) << CGU_BASE_APB1_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_APB1_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_APB1_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_APB1_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_APB1_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_APB1_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_APB3_CLK_PD_MASK (0x1 << CGU_BASE_APB3_CLK_PD_SHIFT)
#define CGU_BASE_APB3_CLK_PD(x) ((x) << CGU_BASE_APB3_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_APB3_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_APB3_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_APB3_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_APB3_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_APB3_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_LCD_CLK_PD_MASK (0x1 << CGU_BASE_LCD_CLK_PD_SHIFT)
#define CGU_BASE_LCD_CLK_PD(x) ((x) << CGU_BASE_LCD_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_LCD_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_LCD_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_LCD_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_VADC_CLK_PD_MASK (0x1 << CGU_BASE_VADC_CLK_PD_SHIFT)
#define CGU_BASE_VADC_CLK_PD(x) ((x) << CGU_BASE_VADC_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_VADC_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_VADC_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_VADC_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_VADC_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_VADC_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_SDIO_CLK_PD_MASK (0x1 << CGU_BASE_SDIO_CLK_PD_SHIFT)
#define CGU_BASE_SDIO_CLK_PD(x) ((x) << CGU_BASE_SDIO_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_SDIO_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_SDIO_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_SDIO_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_SDIO_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_SDIO_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_SSP0_CLK_PD_MASK (0x1 << CGU_BASE_SSP0_CLK_PD_SHIFT)
#define CGU_BASE_SSP0_CLK_PD(x) ((x) << CGU_BASE_SSP0_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_SSP0_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_SSP0_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_SSP0_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_SSP0_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_SSP0_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_SSP1_CLK_PD_MASK (0x1 << CGU_BASE_SSP1_CLK_PD_SHIFT)
#define CGU_BASE_SSP1_CLK_PD(x) ((x) << CGU_BASE_SSP1_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_SSP1_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_SSP1_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_SSP1_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_SSP1_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_SSP1_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_UART0_CLK_PD_MASK (0x1 << CGU_BASE_UART0_CLK_PD_SHIFT)
#define CGU_BASE_UART0_CLK_PD(x) ((x) << CGU_BASE_UART0_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_UART0_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_UART0_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_UART0_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_UART0_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_UART0_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_UART1_CLK_PD_MASK (0x1 << CGU_BASE_UART1_CLK_PD_SHIFT)
#define CGU_BASE_UART1_CLK_PD(x) ((x) << CGU_BASE_UART1_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_UART1_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_UART1_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_UART1_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_UART1_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_UART1_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_UART2_CLK_PD_MASK (0x1 << CGU_BASE_UART2_CLK_PD_SHIFT)
#define CGU_BASE_UART2_CLK_PD(x) ((x) << CGU_BASE_UART2_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_UART2_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_UART2_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_UART2_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_UART2_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_UART2_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_UART3_CLK_PD_MASK (0x1 << CGU_BASE_UART3_CLK_PD_SHIFT)
#define CGU_BASE_UART3_CLK_PD(x) ((x) << CGU_BASE_UART3_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_UART3_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_UART3_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_UART3_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_UART3_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_UART3_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_OUT_CLK_PD_MASK (0x1 << CGU_BASE_OUT_CLK_PD_SHIFT)
#define CGU_BASE_OUT_CLK_PD(x) ((x) << CGU_BASE_OUT_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_OUT_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_OUT_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_OUT_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_OUT_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_OUT_CLK_AUTOBLOCK_SHIFT)
...
/* --- CGU_BASE_AUDIO_CLK values -------------------------------- */

/* PD: Output stage power down */
#define CGU_BASE_AUDIO_CLK_PD_SHIFT (0)
#define CGU_BASE_AUDIO_CLK_PD_MASK (0x1 << CGU_BASE_AUDIO_CLK_PD_SHIFT)
#define CGU_BASE_AUDIO_CLK_PD(x) ((x) << CGU_BASE_AUDIO_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_AUDIO_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_AUDIO_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_AUDIO_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_AUDIO_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_AUDIO_CLK_AUTOBLOCK_SHIFT)

/* CLK_SEL: Clock source selection */
#define CGU_BASE_AUDIO_CLK_CLK_SEL_SHIFT (24)
#define CGU_BASE_AUDIO_CLK_CLK_SEL_MASK (0x1f << CGU_BASE_AUDIO_CLK_CLK_SEL_SHIFT)
#define CGU_BASE_AUDIO_CLK_CLK_SEL(x) ((x) << CGU_BASE_AUDIO_CLK_CLK_SEL_SHIFT)

/* --- CGU_BASE_CGU_OUT0_CLK values ----------------------------- */

/* PD: Output stage power down */
#define CGU_BASE_CGU_OUT0_CLK_PD_SHIFT (0)
#define CGU_BASE_CGU_OUT0_CLK_PD_MASK (0x1 << CGU_BASE_CGU_OUT0_CLK_PD_SHIFT)
#define CGU_BASE_CGU_OUT0_CLK_PD(x) ((x) << CGU_BASE_CGU_OUT0_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_CGU_OUT0_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_CGU_OUT0_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_CGU_OUT0_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_CGU_OUT0_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_CGU_OUT0_CLK_AUTOBLOCK_SHIFT)
...
#define CGU_BASE_CGU_OUT1_CLK_PD_MASK (0x1 << CGU_BASE_CGU_OUT1_CLK_PD_SHIFT)
#define CGU_BASE_CGU_OUT1_CLK_PD(x) ((x) << CGU_BASE_CGU_OUT1_CLK_PD_SHIFT)

/* AUTOBLOCK: Block clock automatically during frequency change */
#define CGU_BASE_CGU_OUT1_CLK_AUTOBLOCK_SHIFT (11)
#define CGU_BASE_CGU_OUT1_CLK_AUTOBLOCK_MASK (0x1 << CGU_BASE_CGU_OUT1_CLK_AUTOBLOCK_SHIFT)
#define CGU_BASE_CGU_OUT1_CLK_AUTOBLOCK(x) ((x) << CGU_BASE_CGU_OUT1_CLK_AUTOBLOCK_SHIFT)
